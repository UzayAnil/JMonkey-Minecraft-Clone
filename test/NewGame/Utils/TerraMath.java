...
public final class TerraMath {
    ...
    public static int calcChunkPosX(int x) {
        ...
        return (x / Clump.CLUMP_DIMENSION_X);
    }
    ...
    public static int calcChunkPosZ(int z) {
        ...
        return (z / Clump.CLUMP_DIMENSION_Z);
    }
    ...
    public static int calcBlockPosX(int x1, int x2) {
        return TerraMath.fastAbs(x1 - (x2 * Clump.CLUMP_DIMENSION_X));
    }
    ...
    public static int calcBlockPosZ(int z1, int z2) {
        return TerraMath.fastAbs(z1 - (z2 * Clump.CLUMP_DIMENSION_Z));
    }
