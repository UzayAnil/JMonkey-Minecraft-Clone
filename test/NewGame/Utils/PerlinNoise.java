...
public class PerlinNoise {
    ...
    public double noise(double x, double y, double z) {
        int X = (int) TerraMath.fastFloor(x) & 255, Y = (int) TerraMath.fastFloor(y) & 255, Z = (int) TerraMath.fastFloor(z) & 255;

        x -= TerraMath.fastFloor(x);
        y -= TerraMath.fastFloor(y);
        z -= TerraMath.fastFloor(z);
